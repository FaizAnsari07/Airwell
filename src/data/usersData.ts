...
export const USERS: User[] = [
  ...
  { id: "U011", name: "Vikram Nair", email: "vikram.nair@starairwell.com", phone: "+91 98765 00011", role: "Sales Manager", department: "Sales Manager", status: "Active", lastLogin: "2026-09-10 09:20", createdAt: "2024-09-01", locationSharing: false, initials: "VN", color: "#B45309", targetAmount: 450 },
  { id: "U012", name: "Rohit Bansal", email: "rohit.bansal@starairwell.com", phone: "+91 98765 00012", role: "Sales Engineer", department: "Sales Engineer", status: "Active", lastLogin: "2026-09-10 08:40", createdAt: "2024-09-15", locationSharing: true, initials: "RB", color: "#0F766E", managerId: "U011", targetAmount: 170 },
  { id: "U013", name: "Sneha Kapoor", email: "sneha.kapoor@starairwell.com", phone: "+91 98765 00013", role: "Sales Engineer", department: "Sales Engineer", status: "Active", lastLogin: "2026-09-11 10:05", createdAt: "2024-10-01", locationSharing: true, initials: "SK", color: "#BE185D", managerId: "U011", targetAmount: 170 },
  { id: "U014", name: "Arjun Mehra", email: "arjun.mehra@starairwell.com", phone: "+91 98765 00014", role: "Site Engineer", department: "Site Engineer", status: "Active", lastLogin: "2026-09-09 17:15", createdAt: "2024-10-10", locationSharing: true, initials: "AM", color: "#4D7C0F", managerId: "U011" },
  { id: "U015", name: "Farah Sheikh", email: "farah.sheikh@starairwell.com", phone: "+91 98765 00015", role: "Field Support", department: "Field Support", status: "Active", lastLogin: "2026-09-08 12:30", createdAt: "2024-11-05", locationSharing: true, initials: "FS", color: "#9333EA", managerId: "U011" },
];
